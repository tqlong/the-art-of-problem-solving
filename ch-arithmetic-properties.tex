...
Hãy nhìn vào đường số ở trên. Chú ý rằng $-2$ và $2$ cách đều điểm $0$,
...
%============================
% 1.4  Số đối — Bài 1.17 và nhắc lại Bài 1.16
%============================
...
%============================
% 1.4  Số đối — Kết quả quan trọng & Bài 1.17
%============================
...
Thực ra, chẳng có gì đặc biệt ở các số ``2'' hay ``3'' trong ví dụ trên. Làm tương tự, ta có thể chứng minh cho mọi số $x$ và $y$:
\[
(-x)y = -(xy).
\]
...
% --- BẮT ĐẦU NỘI DUNG CHÈN VÀO BÊN TRONG \begin{document} ... ---
